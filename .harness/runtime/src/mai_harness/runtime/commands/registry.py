...
COMMANDS.update(
    {
        ...
        "task-reopen": _command("task_reopen", frozenset({"standalone", "managed", "control"})),
        "registry-migrate": _command("document_registry_migrate"),
        ...
        "release-authorization": _command("release_authorization", frozenset({"standalone", "control"})),
        ...
        "promote-test-receipt": _command("promote_test_receipt", frozenset({"standalone"})),
        "promote-test-guard": _command("promote_test_guard", frozenset({"standalone"})),
        "integration-guard": _command("integration_guard", frozenset({"standalone"})),
        "integration-exec": _command("integration_exec", frozenset({"standalone"})),
    }
)
